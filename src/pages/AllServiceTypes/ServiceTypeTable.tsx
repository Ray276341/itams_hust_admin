...
import { deleteServiceType, getAllServiceTypes } from "../../api/serviceType";
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof ServiceType) => (event: React.MouseEvent<unknown>) => {
...
export default function ServiceTypeTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof ServiceType>("id");
  ...
  const [rows, setRows] = React.useState<ServiceType[]>([]);
