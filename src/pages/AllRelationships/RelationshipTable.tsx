...
import { Relationship } from "../../interface/interface";
...
const headCells: readonly HeadCell[] = [
  ...
  {
    id: "relationshipLicenseEntries",
    numeric: false,
    disablePadding: false,
    label: "Software Dependency",
  },
  {
    id: "relationshipServiceEntries",
    numeric: false,
    disablePadding: false,
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof Relationship) => (event: React.MouseEvent<unknown>) => {
...
export default function RelationshipTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Relationship>("id");
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        {row.relationshipLicenseEntries}
                      </TableCell>
                      <TableCell align="left">
                        {row.relationshipServiceEntries}
                      </TableCell>
                      <TableCell align="left">
                        <Actions
                          id={row.id}
