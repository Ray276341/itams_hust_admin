...
import { Service, ServiceQuery } from "../../interface/interface";
...
export default function ServiceTable(serviceQuery: ServiceQuery) {
  ...
  const getData = async () => {
    setLoading(true);
    try {
      const data = await getAllServices(serviceQuery);
      setRows(data);
    } catch (err) {
      console.log(err);
    }
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        <Checkout id={row.id} path="services" data={row} />
                      </TableCell>
                      <TableCell align="left">
                        <Actions
                          id={row.id}
