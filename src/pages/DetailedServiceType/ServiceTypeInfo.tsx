...
import { deleteServiceType, getServiceTypeById } from "../../api/serviceType";
...
export default function ServiceTypeInfo(props: any) {
  ...
  const getData = async () => {
    try {
      const serviceType: ServiceType = await getServiceTypeById(serviceTypeId);
